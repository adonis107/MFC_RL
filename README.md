...
- `src/mfc/algorithms/`: simplex, logits, adaptive, exact/pathwise, classical REINFORCE baseline, continuous MF-REINFORCE, and oracle-sensitivity comparator logic.
